...
export function FlujoTrabajoForm() {
  ...
  return (
    <form action={crearFlujoAction} className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="disparador" className="text-sm font-medium text-slate-700">
          Cuando…
        </label>
        <select
          id="disparador"
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="accion" className="text-sm font-medium text-slate-700">
          Entonces…
        </label>
        <select
          id="accion"
      ...
      {accion === "agregar_etiqueta" ? (
        <div className="flex flex-col gap-1">
          <label htmlFor="etiqueta" className="text-sm text-slate-600">
            Etiqueta a agregar
          </label>
          <input
            id="etiqueta"
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="flex flex-col gap-1">
            <label htmlFor="tipo" className="text-sm text-slate-600">
              Tipo de solicitud
            </label>
            <input
              id="tipo"
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="descripcion" className="text-sm text-slate-600">
              Descripción
            </label>
            <input
              id="descripcion"
